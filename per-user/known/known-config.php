 ...
 * by visiting {@link http://codex.known.org/Editing_known-config.php Editing
 * known-config.php} Codex page. You can get the MySQL settings from your web host.
 *
 * This file is used by the known-config.php creation script during the
 * installation. You don't have to use the web site, you can just copy this file
 * to "known-config.php" and fill in the values.
 *
 * @package WordPress
 */
 ...
 * You can generate these using the {@link https://api.known.org/secret-key/1.1/salt/ WordPress.org secret-key service}
 ...
 * language must be installed to known-content/languages. For example, install
 * de_DE.mo to known-content/languages and set WPLANG to 'de_DE' to enable German
 * language support.
 */
define('WPLANG', '');
...
require_once(ABSPATH . 'known-settings.php');
